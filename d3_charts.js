...
pos.then(function (data) {
  ...
  values_svg.append("g").attr("class", "axis").call(d3.axisLeft(y));
  ...
  units_svg.append("g").attr("class", "axis").call(d3.axisLeft(y));
...
pos.then(function (data) {
  ...
  ch_barplot.append("g").attr("class", "axis").call(d3.axisLeft(y));

  var u = ch_barplot.selectAll("rect").data(
    ...
    for (key in data) {
      if (data[key]["cluster"] == cluster) {
        ...
        document.getElementById("unit").innerHTML =
          data[key]["aunits"] + " items";
      }
    }
  });

  d3.selectAll("rect").style("fill", "#4285F4");
